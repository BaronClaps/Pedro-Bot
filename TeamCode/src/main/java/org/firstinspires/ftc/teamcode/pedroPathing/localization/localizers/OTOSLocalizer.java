...
public class OTOSLocalizer extends Localizer {
    ...
    public OTOSLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        // For the OTOS, left/right is the y axis and forward/backward is the x axis, with right being
        // positive y and forward being positive x. Clockwise rotation is negative rotation.
        otos.setOffset(new SparkFunOTOS.Pose2D(6.585, 0, Math.PI/2));
